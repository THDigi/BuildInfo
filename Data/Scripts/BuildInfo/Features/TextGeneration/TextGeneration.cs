        ...
        private void Format_Weapon(MyCubeBlockDefinition def)
        {
            ...
            if(gunWWF != null)
            {
                ...
                if(showAmmoDetails)
                {
                    ...
                    {
                        MyAmmoMagazineDefinition magDef = Main.Caches.AmmoMagDefs.GetValueOrDefault(wpDef.AmmoMagazinesId[0]);
                        if(magDef != null)
            ...
            if(gunWWF == null) // vanilla weapon system
            {
                ...
                {
                    MyAmmoMagazineDefinition mag = Main.Caches.AmmoMagDefs.GetValueOrDefault(wpDef.AmmoMagazinesId[i]);
                    MyAmmoDefinition ammo = (mag != null ? Main.Caches.AmmoDefs.GetValueOrDefault(mag.AmmoDefinitionId) : null);

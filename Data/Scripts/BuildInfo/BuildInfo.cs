...
namespace Digi.BuildInfo
{
    ...
    public partial class BuildInfo : MySessionComponentBase
    {
        ...
        public override void BeforeStart()
        {
            ...
            // DEBUG TESTING STUFF
            //{
            //    Log.Info("=== Airtightness status of blocks: ===");
            ...
            //        int airTightFaces = 0;
            //        int totalFaces = 0;
            //        var airTight = GetAirTightFaces(blockDef, ref airTightFaces, ref totalFaces);

            //        var text = $" {blockDef.Id} - ";

            //        if(airTight == Pressurization.AirTightMode.SEALED)
            //            text += "Sealed";
            //        else if(airTight == Pressurization.AirTightMode.NOT_SEALED)
            //            text += "NOT sealed";
            //        else
            //            text += $"{airTightFaces} of {totalFaces} faces are airtight";
            ...
            //} 
            //{
            //    Log.Info("=== Blocks that need IsAirTight tag ===");

            //    List<string> airtight = new List<string>();
            //    List<string> notAirtight = new List<string>();
            ...
            //        if(airTight != Pressurization.AirTightMode.USE_MOUNTS)
            //            continue;

            //        var text = $" {blockDef.Id} - {airTightFaces} of {totalFaces} faces are airtight";

            //        if(airTightFaces == totalFaces)
            //            airtight.Add(text);
            //        else if(airTightFaces == 0)
            //            notAirtight.Add(text);
            //    }

            //    Log.Info("");
            //    Log.Info("");
            //    Log.Info("=== Airtight blocks ===");

            //    foreach(var text in airtight)
            //    {
            //        Log.Info(text);
            //    }
            ...
            //    Log.Info("");
            //    Log.Info("");
            //    Log.Info("=== Not airtight blocks ===");

            //    foreach(var text in notAirtight)
            //    {
            //        Log.Info(text);
            //    }
            ...
            //        // ignore IsAirTight true and false, only care about null
            //        if(airTight == Pressurization.AirTightMode.USE_MOUNTS)
            //        {
            //            if(airTightFaces == 0) // block is entirely not sealed
            //            {
            //                blockDef.IsAirTight = false; // optimize airtightness shortcut
            //            }
            //            else if(airTightFaces == totalFaces)
            //            {
            //                blockDef.IsAirTight = true; // optimize airtightness shortcut
            //            }
            //        }
            //    }
            //}
